...
const organizationSchema = {
  ...
  url: "https://muni.works",
  logo: "https://muni.works/images/og.png",
  description: "Autonomous sidewalk maintenance robots for municipalities.",
  foundingDate: "2025",
  foundingLocation: {
    "@type": "Place",
    name: "Cleveland, Ohio",
  ...
  sameAs: [
    ...
    "https://www.linkedin.com/company/municipal-robotics",
    "https://x.com/campedersen",
  ],
  contactPoint: {
    "@type": "ContactPoint",
    email: "info@muni.works",
    contactType: "sales",
  },
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <link rel="preload" href="/models/bvr1_assembly.glb" as="fetch" crossOrigin="anonymous" />
        <script
