...
//!
//! Copied from bvr/firmware/crates/sim/src/vesc.rs with local CanFrame type.
...
impl SimVesc {
    ...
    pub fn process_command(&mut self, frame: &CanFrame) -> bool {
        if !frame.extended {
            return false;
        }
    ...
    pub fn tick(&mut self, dt: f64) {
        ...
        let max_change = (5000.0 * dt) as i32;
    ...
    pub fn generate_status(&self) -> Vec<CanFrame> {
        ...
        frames.push(CanFrame::new_extended(id1, &data1));
