...
// Helper to determine color based on channel health
// Defined here to keep sparkline self-contained
function getChannelColorInternal(
...
export { getChannelColorInternal as getChannelColor };
