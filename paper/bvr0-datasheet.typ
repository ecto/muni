  ...
  [
    ...
    #figure(
      cetz.canvas({
        ...
        // Top view
        rect((-2, -2), (2, 2), stroke: 1pt + black)
        
        // Wheels
        rect((-2.3, 1.5), (-2, 2.3), fill: black)
        rect((2, 1.5), (2.3, 2.3), fill: black)
        rect((-2.3, -2.3), (-2, -1.5), fill: black)
        rect((2, -2.3), (2.3, -1.5), fill: black)
        
        // Dimensions
        line((-2, -3), (2, -3), stroke: 0.5pt + gray)
        line((-2, -2.8), (-2, -3.2), stroke: 0.5pt + gray)
        line((2, -2.8), (2, -3.2), stroke: 0.5pt + gray)
        content((0, -3.4), text(size: 7pt)[600 mm])
        
        line((3, -2), (3, 2), stroke: 0.5pt + gray)
        line((2.8, -2), (3.2, -2), stroke: 0.5pt + gray)
        line((2.8, 2), (3.2, 2), stroke: 0.5pt + gray)
        content((3.7, 0), text(size: 7pt)[600 mm])
        
        // Front arrow
        line((0, 2.5), (0, 3.2), stroke: 0.5pt + black, mark: (end: ">"))
        content((0, 3.5), text(size: 6pt)[FRONT])
      }),
      caption: [Top view],
    )
  ],
